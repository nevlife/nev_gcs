...
class CameraVideoTrack(VideoStreamTrack):
    ...
    kind = "video"
    _BLACK_FRAME = None  # lazily created
    ...
    @classmethod
    def _black_frame(cls) -> av.VideoFrame:
        if cls._BLACK_FRAME is None:
            cls._BLACK_FRAME = av.VideoFrame(width=640, height=480, format="yuv420p")
        return cls._BLACK_FRAME
